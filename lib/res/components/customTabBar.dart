...
class _CustomTabBarState extends State<CustomTabBar> {
  ...
  Color textIconColor = const Color.fromARGB(255, 255, 255, 255);
  Color textIconColorGray = Colors.grey;
          ...
          children: [
            Expanded(
              child: TabBarCustomButton(
                ...
                text: "Groups",
                textColor:
                    widget.index == 0 ? textIconColor : textIconColorGray,
                borderColor:
            ...
            Expanded(
              child: TabBarCustomButton(
                text: "Users",
                textColor:
                    widget.index == 1 ? textIconColor : textIconColorGray,
                borderColor:
            ...
            Expanded(
              child: TabBarCustomButton(
                text: "Profile",
                textColor:
                    widget.index == 2 ? textIconColor : textIconColorGray,
                borderColor:
